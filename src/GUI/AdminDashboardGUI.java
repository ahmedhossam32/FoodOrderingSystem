...
public class AdminDashboardGUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton2.setText("Assign delivery person");
        ...
        jLabel2.setText("Move Order status:");
   ...
   new UpdateOrderGUI().setVisible(true);
   this.dispose();
